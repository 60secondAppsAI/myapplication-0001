						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="FullName" type="text" placeholder="Enter FullName" v-model="userToAdd.fullName"></base-input>
            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Full Name</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="FullName" type="text" placeholder="Enter FullName" v-model="userDetails.fullName"></input>
																		</div>
						</td>
														</tr>
															<tr> 
