						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="PassengerCount" type="text" placeholder="Enter PassengerCount" v-model="reservationToAdd.passengerCount"></base-input>
								  <base-input label="ContactName" type="text" placeholder="Enter ContactName" v-model="reservationToAdd.contactName"></base-input>
								  <base-input label="ContactEmail" type="text" placeholder="Enter ContactEmail" v-model="reservationToAdd.contactEmail"></base-input>
												                  </form>
								                </div>
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Reservation Id</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Passenger Count</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="PassengerCount" type="text" placeholder="Enter PassengerCount" v-model="reservationDetails.passengerCount"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Contact Name</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="ContactName" type="text" placeholder="Enter ContactName" v-model="reservationDetails.contactName"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Contact Email</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="ContactEmail" type="text" placeholder="Enter ContactEmail" v-model="reservationDetails.contactEmail"></input>
																		</div>
						</td>
														</tr>
